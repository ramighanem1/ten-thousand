...
class MyBot_1(BaseBot):

    def _roll_bank_or_quit(self):
        """
        if dice_remaining two or less quit
        """
...
class MyBot_2(BaseBot):
    # def _roll_bank_or_quit(self):
    #     """your logic here"""
    #     return "b"
    def _roll_bank_or_quit(self):
        """
        get the score if the first roll is hot dice
...
if __name__ == "__main__":
    ...
    MyBot_1.play(num_games)
    MyBot_2.play(num_games)
